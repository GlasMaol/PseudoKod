...
Input "tip"
    If "tip" är en siffra fortsätt till nästa steg;
        If tip > 0; (Kollar om siffran är mer än noll)
        End If    
    End If
    Else If "tip" är annat än siffra go tillbaka till input "tip";
    End Else
End Input

Input "total"
    If "total" är en siffra fortsätt till nästa steg;
       If total > 0; 
        End If
...
Input "numberOfFriends"
    If "numberOfFriends" är en siffra fortsätt till nästa steg;
        If total > 0; 
        End If
    End If
